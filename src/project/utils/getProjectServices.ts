...
export const getProjectServices = (
  ...
  const services: ServiceConfiguration[] = [getAutoGeneratedAttributes(SERVICE_TYPE.STATE, project)]
  ...
  for (const serviceConfig of serviceConfigurations) {
    ...
    Object.values(service.associations).forEach((association) => {
      ...
      services.push(getAutoGeneratedAttributes(requiredServiceType, project, serviceConfig))
    })
