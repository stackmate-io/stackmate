...
export class YamlFormatter implements FileFormatter {
   ...
   */
  serialize(contents: object): string {
    const doc = new YAML.Document(contents);
    doc.commentBefore = `
 This file is automatically generated by Stackmate
 If you need to manually edit this file, please make sure you read the documentation:
 http://docs.stackmate.io
`;
