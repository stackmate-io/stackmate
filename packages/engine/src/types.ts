...
export type ServiceMapping = Map<ServiceTypeChoice, ConstructorOf<IService>>;
...
export type ServiceAttributes = {
  environment?: EnvironmentVariablesDeclaration;
  associations?: ServiceAssociationDeclarations;
};

export type ServiceAssociation = {
  lookup: ConstructorOf<IService>,
  onRegister: (a: Array<IService>) => void,
};
...
export type ServiceList = Map<string, IService>;
